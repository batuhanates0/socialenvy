...
function test(id) {
   ...
   // var divActivity = "divActivity" + "_" +id ;
    ...
    if(valueOfdiv=='Start')
    {
        ...
        $("#clickstart"+ "_" +id).removeClass('btn btn-success');
        $("#clickstart"+ "_" +id).addClass('btn btn-danger');
        $("#divActivity" + "_" +id).removeClass('fa fa-play');
        $("#divActivity" + "_" +id).addClass('fa fa-stop');
        updatestatus(id);
    }else{
        $("#divActivity" + "_" +id).html("Start");
        $("#clickstart"+ "_" +id).removeClass('btn btn-danger');
        $("#clickstart"+ "_" +id).addClass('btn btn-success');
